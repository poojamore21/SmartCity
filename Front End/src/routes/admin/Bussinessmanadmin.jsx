...
const categories = ["hotel", "marketArea"];

const Bussinessmanadmin = () => {
  ...
  return (
    <div>
      <h1 className="text-center text-2xl text-black mt-4">
        BussinessMan Portal Information
      </h1>
      <Container
        maxWidth="md"
...
export default Bussinessmanadmin;
